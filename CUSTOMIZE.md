...
Here we will give you some tips on how to customize the website. One important thing to note is that **ALL** the changes you make should be done on the **main** branch of your repository. The site is built and deployed to GitHub Pages automatically from your workflow runs.
